...
public class RegisterPageTest extends BaseTest {
    ...
    public void verifyThatUserShouldCreateAccountSuccessfully() {
        ...
        //Enter firstname
        registerPage.enterFirstName("Nilesh");

        //Enter lastname
        registerPage.enterLastName("Joshi");

        //Select day
        registerPage.selectDayOfBirthDay("19");

        //Select month
        registerPage.selectMonthOfBirthDay("May");
        //Select year
        registerPage.selectYearOfBirthDay("1988");

        //Enter email
        registerPage.enterEmail("primeteam1@test.com");

        //Enter password
        registerPage.enterPassword("Penpencil");

        //Enter Confirm Password
        registerPage.enterConfirmPassword("Penpencil");
